...
class ROSLauncher(object):
    def __init__(self, rospackage_name, launch_file_name, ros_ws_abspath="/home/user/simulation_ws", launch_arg_string=""):
        ...
        if pkg_path:
            ...
            command = source_env_command + " " + roslaunch_command + " " + launch_arg_string
    ...
    def DownloadRepo(self, package_name, ros_ws_abspath):
        ...
        elif package_name == "modrob_simulation":

            url_git_1 = "https://gitlab.lrz.de/modularrobot/20ws/general/modrob_simulation.git"
            package_git = [url_git_1]
            package_to_branch_dict[url_git_1] = "master"
