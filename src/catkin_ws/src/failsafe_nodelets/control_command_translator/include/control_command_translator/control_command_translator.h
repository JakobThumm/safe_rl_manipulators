...
/**
 * @brief Takes the robot config commanded signal and translates it to a simpler ROS control signal.
 */
class ControlCommandTranslator{
 ...
 public:
   ...
   */
  void convertMsg(const modrob_workstation::RobotConfigCommandedConstPtr& robot_config_command);
};
} // namespace control_command_translator
