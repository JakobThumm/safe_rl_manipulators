 ...
 */
class AdvancedVerifyISO : public VerifyISO{
 ...
 public:
   ...
   */
  AdvancedVerifyISO() : VerifyISO() {}
 
  /**
   * @brief Basic constructor
   */
  AdvancedVerifyISO(const ros::Publisher &pub_safe) : VerifyISO(pub_safe) {}
   ...
   */
  bool robotHumanCollision(const custom_robot_msgs::StartGoalCapsuleArrayConstPtr& robot_capsules, const custom_robot_msgs::CapsuleArrayConstPtr& human_capsules);
   ...
   */
  void verify_human_reach(const custom_robot_msgs::StartGoalCapsuleArrayConstPtr& robot_capsules, const custom_robot_msgs::CapsuleArrayConstPtr& human_reach_capsules_P, 
                          const custom_robot_msgs::CapsuleArrayConstPtr& human_reach_capsules_V, const custom_robot_msgs::CapsuleArrayConstPtr& human_reach_capsules_A);
};
} // namespace verify_iso
