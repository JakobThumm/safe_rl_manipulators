...
class VerifyISO {
 protected:
  /**
   * @brief ROS publisher for verification of failsafe trajectory safety
   */
  ros::Publisher pub_safe_;
 ...
 public:
   ...
   */
  bool robotHumanCollision(const custom_robot_msgs::CapsuleArrayConstPtr& robot_capsules, 
      const custom_robot_msgs::CapsuleArrayConstPtr& human_capsules);

  /**
   * @brief An empty VerifyISO constructor
   */
  VerifyISO() {}
   ...
   */
  VerifyISO(const ros::Publisher &pub_safe):
    pub_safe_(pub_safe)
  {}
   ...
   */
  void verify(const custom_robot_msgs::CapsuleArrayConstPtr& robot_ra, 
   ...
   */
  void verify_human_reach(const custom_robot_msgs::CapsuleArrayConstPtr& robot_capsules, 
