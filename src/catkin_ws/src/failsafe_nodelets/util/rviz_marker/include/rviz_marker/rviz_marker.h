...
class RvizMarker{
 ...
 private:
   ...
   */
  void human_reach_calc(const custom_robot_msgs::CapsuleArrayConstPtr& data, 
 ...
 public:
   ...
   */
  void robot_callback(const custom_robot_msgs::CapsuleArrayConstPtr& data);

  /**
   * @brief Reads the robot capsule data and updates and sends the rviz markers
   */
  void advanced_robot_callback(const custom_robot_msgs::StartGoalCapsuleArrayConstPtr& data);

  /**
   * @brief Reads the human cylinder polycapsule data and updates and sends the rviz markers
   */
  void human_cylinder_callback(const custom_robot_msgs::PolycapsuleArrayConstPtr& data);
  
  /**
   * @brief Reads the human reach capsule data and updates and sends the rviz markers
   */
  void human_reach_callback_p(const custom_robot_msgs::CapsuleArrayConstPtr& data);

  /**
   * @brief Reads the human reach capsule data and updates and sends the rviz markers
   */
  void human_reach_callback_v(const custom_robot_msgs::CapsuleArrayConstPtr& data);
  
  /**
   * @brief Reads the human reach capsule data and updates and sends the rviz markers
   */
  void human_reach_callback_a(const custom_robot_msgs::CapsuleArrayConstPtr& data);
