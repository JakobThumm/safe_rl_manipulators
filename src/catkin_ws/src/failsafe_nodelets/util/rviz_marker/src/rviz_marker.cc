...
void RvizMarker::robot_callback(const custom_robot_msgs::CapsuleArrayConstPtr& data) {
  try {
...
void RvizMarker::advanced_robot_callback(const custom_robot_msgs::StartGoalCapsuleArrayConstPtr& data) {
  try {
    custom_robot_msgs::CapsuleArrayPtr cap(new custom_robot_msgs::CapsuleArray());
...
void RvizMarker::human_cylinder_callback(const custom_robot_msgs::PolycapsuleArrayConstPtr& data) {
...
void RvizMarker::human_reach_callback_p(const custom_robot_msgs::CapsuleArrayConstPtr& data) {
  try {
...
void RvizMarker::human_reach_callback_v(const custom_robot_msgs::CapsuleArrayConstPtr& data) {
  try {
...
void RvizMarker::human_reach_callback_a(const custom_robot_msgs::CapsuleArrayConstPtr& data) {
  human_reach_calc(data, this->human_reach_markers_A_);
  this->human_reach_visu_pub_A_.publish(this->human_reach_markers_A_);
}

void RvizMarker::human_reach_calc(const custom_robot_msgs::CapsuleArrayConstPtr& data, 
...
void RvizMarker::createCapsules(visualization_msgs::MarkerArray& markers, 
    const custom_robot_msgs::CapsuleArrayConstPtr& capsules) { 
